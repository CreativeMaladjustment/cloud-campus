...
3. **Checks it locally** — before exposing anything publicly, it curls the function directly on the runner with the Function URL's own `Host` header, to confirm routing works before troubleshooting would require going through the tunnel.
